...
namespace ARExercise
{
    public static class UtilityAR
    {
        ...
        private static readonly int frameWidth = 800;
        private static readonly int frameHeight = 600;
        ...
        public static void CaptureLoop(Size PatternSize, int camIndex = 0)
        {
            ...
            using VideoCapture vcap = new(camIndex);
            ...
            while (true)
            {
                ...
                VectorOfPointF cornerPoints = new();
                ...
                Mat chessboardCornersFrame = new();
        ...
        public static void CalibrateCamera(Size PatternSize, bool showPreview = true)
        {
            ...
            List<MCvPoint3D32f[]> listOfObjectPoints = new();
            List<VectorOfPointF> listOfCornerPoints = new();
            ...
            using FileStorage fs = new("intrinsics.json", FileStorage.Mode.Write);
        ...
        {
            Mat intrinsicsMat = new();
            Mat distCoeffsMat = new();

            using FileStorage fs = new("intrinsics.json", FileStorage.Mode.Read);
        ...
        {
            List<MCvPoint3D32f> objPoints = new();
